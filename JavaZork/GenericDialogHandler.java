...
public class GenericDialogueHandler implements DialogueHandler {
    ...
    public GenericDialogueHandler() {}

    public static GenericDialogueHandler fromJson(String filePath) {
        try {
            ObjectMapper mapper = new ObjectMapper();
            return mapper.readValue(new File(filePath), GenericDialogueHandler.class);
        } catch (Exception e) {
